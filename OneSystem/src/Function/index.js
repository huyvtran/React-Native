...
import {Detail} from './index';
  ...
  onReMove(ids,deleteRow){
    const JSON =  fetch("http://onesystemadmin.azurewebsites.net/api/function?id="+ids,{
      method:'DELETE',
    }).then(function(res){
...
class ShowUsers  extends Component {
  ...
  onLearnMore = (item) => {  
    this.props.navigation.navigate('FunctionManage', { ...item });
   };
  fetchdata = async () => {
    const reponse = await fetch("http://onesystemadmin.azurewebsites.net/api/function");
...
componentDidMount() {
 ...
 refresh(){ 
        this.props.navigation.navigate('ShowFunction');
 }
  render() {
